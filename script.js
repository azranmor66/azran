    ...
    const html = treeConfig.links
        ...
        .map(link => {
            ...
            const CUSTOM_ICONS = {
                ...
                'message-circle':`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M5.077 0C2.274 0 0 2.274 0 5.077v13.846C0 21.726 2.274 24 5.077 24h13.846C21.726 24 24 21.726 24 18.923V5.077C24 2.274 21.726 0 18.923 0H5.077zm6.923 18.906c-1.12 0-2.22-.3-3.18-.867l-3.527.924.943-3.447a6.832 6.832 0 0 1-.915-3.416C5.321 8.554 8.554 5.32 12 5.32s6.679 3.234 6.679 7.28c0 4.045-3.233 7.306-6.679 7.306z"/></svg>`,
                ...
                handshake:       `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5 8.5 7l2 2 3-3 2 2-5 5-3-2.5z"/><path d="m15 7 1.5-1.5a2.12 2.12 0 0 1 3 3L18 10"/><path d="m9 17-1.5 1.5a2.12 2.12 0 0 1-3-3L6 14"/><path d="m13.5 12.5 3 3-3.5 3.5-3-3"/><path d="m6 9 3 3"/></svg>`,
            };
